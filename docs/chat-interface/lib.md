...
- [🎙️ expo-speech-recognition](#️-expo-speech-recognition)
  - [Table of Contents](#table-of-contents)
  - [Installation](#installation)
    - [Important Note for Expo Beginners](#important-note-for-expo-beginners)
  ...
  - [Platform Compatibility Table](#platform-compatibility-table)
    - [Mobile Platforms (React Native)](#mobile-platforms-react-native)
    - [Web Platforms](#web-platforms)
  - [Common Troubleshooting Issues](#common-troubleshooting-issues)
    - [Speaker is getting picked up by the microphone](#speaker-is-getting-picked-up-by-the-microphone)
    - [Android issues](#android-issues)
      - [Single words/letters/characters not recognized](#single-wordsletterscharacters-not-recognized)
      - [Speech recognition unavailable, not supported, or hanging](#speech-recognition-unavailable-not-supported-or-hanging)
      - [On-device recognition not working](#on-device-recognition-not-working)
    - [iOS issues](#ios-issues)
      - [Audio session issues / crashes](#audio-session-issues--crashes)
      - [Permissions issues even though the app is explicitly allowed in Settings](#permissions-issues-even-though-the-app-is-explicitly-allowed-in-settings)
  - [API Methods](#api-methods)
    - [`start(options: SpeechRecognitionOptions): void`](#startoptions-speechrecognitionoptions-void)
    - [`stop(): void`](#stop-void)
    ...
    - [`getStateAsync(): Promise<SpeechRecognitionState>`](#getstateasync-promisespeechrecognitionstate)
    - [`getSupportedLocales()`](#getsupportedlocales)
    - [`getSpeechRecognitionServices(): string[]` (Android only)](#getspeechrecognitionservices-string-android-only)
    - [`getDefaultRecognitionService(): { packageName: string }` (Android only)](#getdefaultrecognitionservice--packagename-string--android-only)
    - [`getAssistantService(): { packageName: string }` (Android only)](#getassistantservice--packagename-string--android-only)
    - [`isRecognitionAvailable(): boolean`](#isrecognitionavailable-boolean)
    - [`supportsOnDeviceRecognition(): boolean`](#supportsondevicerecognition-boolean)
    - [`supportsRecording(): boolean`](#supportsrecording-boolean)
    - [`androidTriggerOfflineModelDownload()`](#androidtriggerofflinemodeldownload)
    - [`setCategoryIOS({...}): void` (iOS only)](#setcategoryios-void-ios-only)
    - [`getAudioSessionCategoryAndOptionsIOS()` (iOS only)](#getaudiosessioncategoryandoptionsios-ios-only)
    - [`setAudioSessionActiveIOS(value: boolean, options?: { notifyOthersOnDeactivation: boolean }): void`](#setaudiosessionactiveiosvalue-boolean-options--notifyothersondeactivation-boolean--void)
  - [System Overview Diagrams](#system-overview-diagrams)
    - [Overall Architecture](#overall-architecture)
    - [Event Flow](#event-flow)
      - [Non-continuous recognition](#non-continuous-recognition)
