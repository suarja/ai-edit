/**
 * 🎨 GeneratedVideoDetailScreen v2 - Migré vers la Palette Editia
 * 
 * MIGRATION PHASE 3:
 * ❌ Avant: 8 couleurs hardcodées pour page de détail vidéo générée
...
export default function GeneratedVideoDetailScreenV2() {
...
const styles = StyleSheet.create({
  ...
  // ✅ Thumbnail container avec design cohérent
  thumbnailContainer: {
    width: '100%',
    height: 240,
    ...
    alignItems: 'center',
    overflow: 'hidden',
    borderRadius: 12, // Ajout border radius moderne
  },
  
  // ✅ Thumbnail overlay avec overlay forte
  thumbnailOverlay: {
    position: 'absolute',
    width: '100%',
    height: '100%',
    backgroundColor: COLORS.background.overlayMedium, // rgba(0, 0, 0, 0.6)
    justifyContent: 'center',
    alignItems: 'center',
...
/**
 * 🎨 RÉSUMÉ DE LA MIGRATION GENERATED VIDEO DETAIL SCREEN:
 * 
 * ✅ COULEURS PRINCIPALES MIGRÉES:
 * • ActivityIndicator: #007AFF → #FF0050 (Rouge Editia) pour tous les états loading
 * • Container background: #000 → COLORS.background.primary (#000000)
 * • LoadingText: #888 → COLORS.text.tertiary (#B0B0B0)
 * • ThumbnailContainer: #1a1a1a → COLORS.background.secondary (#1a1a1a)
 * • ThumbnailOverlay: rgba(0,0,0,0.5) → COLORS.background.overlayMedium (rgba(0,0,0,0.6))
 * • ProcessingText: #fff → COLORS.text.primary (#FFFFFF)
 * • PromptText: #888 → COLORS.text.tertiary (#B0B0B0)
 * 
 * 🎯 AMÉLIORATIONS INTERFACE:
 * • Loading container avec gap moderne
 * • Thumbnail container avec border radius (12px)
 * • Line heights améliorées pour lisibilité
 * • Overlay plus forte pour meilleur contraste
 * • ActivityIndicator en Rouge Editia partout pour cohérence
 * • Typography hiérarchisée (primary, tertiary)
 * 
 * 🚀 NOUVEAUTÉS:
 * • Border radius sur thumbnail container
 * • Line heights optimisées (22px pour processing, 20px pour prompt)
 * • Gap de 16px sur loading container
 * • Overlay medium (60% au lieu de 50%)
 * • Couleurs cohérentes avec design système
 * 
 * 8 couleurs hardcodées → Interface Détail Vidéo cohérente Editia ✨
 */